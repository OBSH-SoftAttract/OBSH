...
public class MemberTest {
	...
	public void testgetRank () {
		...
		MemberBLService member1 = new MemberBLService();
		MemberBLService member2 = new MemberBLService();
		
		assertEquals(1, member1.getRank(credit1));
		assertEquals(3, member2.getRank(credit2));
	...
	public void testcreateByBusiness () {
		...
		member1.createByBusiness(user1.getCorpoateName("蒙牛"));
	...
	public void testcreateByPersonal () {
		...
		member1.addUser(user1.getId());
		member1.createByPersonal(user1.getBirthday(1997/11/23));
